...
module.exports = __webpack_require__(/*! C:\wamp64\www\desafio-ripley\desafio-ripley-front\src\main.ts */"zUnb");
...
class AuthGuard {
    ...
    canActivate(route, state) {
        return this.as.secret().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["tap"])(auth => {
            if (!auth) {
...
AuthGuard.ɵfac = function AuthGuard_Factory(t) { return new (t || AuthGuard)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"])); };
...
class AppComponent {
    constructor() {
        this.title = 'desafio-ripley-front';
    }
}
...
/* harmony import */ var _interceptors_interceptor_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./interceptors/interceptor.service */ "SRPq");
/* harmony import */ var _shared_error_page_error_page_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./shared/error-page/error-page.component */ "8puP");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineInjector"]({ providers: [
        _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClientModule"],
        {
            ...
            useClass: _interceptors_interceptor_service__WEBPACK_IMPORTED_MODULE_4__["InterceptorService"],
            multi: true
        }
    ], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"],
        _shared_error_page_error_page_component__WEBPACK_IMPORTED_MODULE_5__["ErrorPageComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClientModule"]] }); })();
...
class AuthService {
    ...
    secret() {
        return this.http.get(`${base_url}/secret/${localStorage.getItem('userId')}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(resp => {
...
/* harmony import */ var _auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./auth/guards/auth.guard */ "PC/O");
...
const routes = [
    {
        path: 'transferencias',
        loadChildren: () => Promise.all(/*! import() | transferencias-transferencias-module */[__webpack_require__.e("default~auth-auth-module~transferencias-transferencias-module"), __webpack_require__.e("transferencias-transferencias-module")]).then(__webpack_require__.bind(null, /*! ./transferencias/transferencias.module */ "6RD6")).then(module => module.TransferenciasModule),
        canActivate: [_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"]]
    },
    {
        path: 'auth',
        loadChildren: () => Promise.all(/*! import() | auth-auth-module */[__webpack_require__.e("default~auth-auth-module~transferencias-transferencias-module"), __webpack_require__.e("auth-auth-module")]).then(__webpack_require__.bind(null, /*! ./auth/auth.module */ "Yj9t")).then(module => module.AuthModule)
    },
    {
        path: '',
        pathMatch: 'full',
